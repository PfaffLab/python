...
#==============================================================================
def make_reads(seq_name, seq, read_length, cov, err):
	num_reads = 0
	made_reads = 0
	ppos = 0
	made_reads = 0
...
# Creates random reads from single sequence and passes them to a list
#==============================================================================
def make_paired_reads(seq_name, seq, read_length, cov, frag_len, frag_sdev, err):
...
#				read2 = reverse_comp(seq[ppos2:(ppos2+read_length)])
			...
			if len(read1) == read_length and len(read2) == read_length:
				...
				#res_queue.put([rheader, read1, read2])
				made_reads += 1
